        ...
        <el-table-column align="center" label="操作" width="180">
          <template slot-scope="scope">
            <el-button size="mini" icon="el-icon-search"
              @click="$imgPreview([scope.row.litpic, scope.row.processName])">查看流程图
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="新增流程" width="600px" center :visible.sync="addInfo.isOpen" :show-close="false">
      <el-form :model="addInfo.form" ref="formByAdd" :rules="rules" label-width="80px">
        ...
        <el-form-item label="选择流程" prop="file">
          <el-upload ref="addUpload" action="xxx" :auto-upload="false" :on-change="changeAddFile"
            :on-remove="removeAddFile">
